    ...
    <div className="max-w-5xl space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle as="h3" className="flex items-center gap-2 text-base">
              <UserRound className="text-primary h-4 w-4" /> Identidade
            </CardTitle>
            <CardDescription>
              Quem é este agente. Estes campos ajudam o modelo a apresentar-se e
              a equipa a identificar o agente.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-xs">
                Usado apenas quando o idioma do cliente é ambíguo.
              </p>
            </div>
            <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Política desta conta. Cada empresa pode ter um comportamento
            diferente sem alterar o motor comum.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 sm:grid-cols-2 sm:items-start">
          <div className="border-border space-y-2 rounded-md border p-3 sm:col-span-2">
            <Label htmlFor="ai-initiative-mode">Modo de iniciativa</Label>
            <p className="text-muted-foreground text-xs">
              Define quando o agente deve esclarecer antes de executar acções.
            </p>
            <Select
              value={state.initiativeMode}
              onValueChange={(value) =>
                state.setInitiativeMode(value as typeof state.initiativeMode)
              }
              disabled={disabled}
            >
              <SelectTrigger id="ai-initiative-mode">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="conversation_first">
                  Conversacional — compreender antes de agir
                </SelectItem>
                <SelectItem value="balanced">
                  Equilibrado — agir quando o objectivo está claro
                </SelectItem>
                <SelectItem value="action_first">
                  Proactivo — avançar rapidamente
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="border-border flex items-center justify-between gap-4 rounded-md border p-3">
            <div>
              <p className="text-foreground text-sm font-medium">
                Apresentação visual automática
              </p>
              <p className="text-muted-foreground text-xs">
                Quando desligado, a conversa fica primeiro em texto e a
                apresentação visual só é usada quando o cliente a pede.
              </p>
            </div>
            <Switch
          ...
          <div className="border-border flex items-center justify-between gap-4 rounded-md border p-3">
            <div>
              ...
              <p className="text-muted-foreground text-xs">
                Recomenda apenas quando a necessidade do cliente já está
          ...
          <div className="border-border flex items-center justify-between gap-4 rounded-md border p-3">
            <div>
              ...
              <p className="text-muted-foreground text-xs">
                Consulta o stock antes de confirmar disponibilidade.
              </p>
            </div>
            <Switch
          ...
          <div className="border-border flex items-center justify-between gap-4 rounded-md border p-3">
            <div>
              <p className="text-foreground text-sm font-medium">
                Manter item seleccionado
              </p>
              <p className="text-muted-foreground text-xs">
                Mantém o item escolhido até o cliente o rejeitar ou mudar de
                assunto.
              </p>
            </div>
            <Switch
          ...
          <div className="border-border space-y-2 rounded-md border p-3 sm:col-span-2">
            <Label htmlFor="ai-qualification-order">
              Ordem de qualificação
            </Label>
            <p className="text-muted-foreground text-xs">
              Para contas de catálogo que usam tamanho e cor.
            </p>
            <Select
              value={state.qualificationOrder}
              onValueChange={(value) =>
                state.setQualificationOrder(
                  value as typeof state.qualificationOrder
                )
              }
              disabled={disabled}
            >
