...
/** `elevated` bumps the card to the "elevated surface" level from the
 *  design system's surface scale (globals.css) — a soft shadow on top
 *  of the resting ring, for content that should read as raised above
 *  the page (a metric tile the eye should land on first, a popover-
 *  like panel). Leave it off for ordinary section cards. */
function Card({
  className,
  size = 'default',
  elevated = false,
