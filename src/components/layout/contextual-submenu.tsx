 ...
 * the same responsive behaviour `settings-rail.tsx` already
 * established for a page-local rail, generalised one level up.
 */
export function ContextualSubmenu({ area }: { area: NavArea }) {
  ...
  return (
    <aside
      ...
      className="w-full shrink-0 border-b border-border bg-sidebar/40 px-3 py-2 lg:w-48 lg:border-r lg:border-b-0 lg:px-3 lg:py-4"
    >
      <nav
        className={cn(
