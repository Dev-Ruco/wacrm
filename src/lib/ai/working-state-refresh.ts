...
const EXTRACTOR_PROMPT = [
  ...
  'The newest customer statement overrides older state. Corrections, rejections and changes of mind must remove stale assumptions. Clear a selected entity when it is rejected.',
