...
export function buildSystemPrompt(args: {
  ...
  const parts: string[] = [
    ...
    'Grounded business-facts rule: when the customer asks for a factual detail about this business — including address/location, opening hours, contacts, payment methods, delivery or pickup conditions, returns/exchanges, policies, services or other company-specific facts — and search_knowledge is available, you MUST call search_knowledge in that turn before answering. Never expose an internal placeholder such as “I need the address”; either answer from retrieved knowledge or say naturally that the information is not available.',
